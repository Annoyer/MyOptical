...
<div class="page_content">
    ...
    <form id="dataForm" action="/jsp/admin/itemAdd" method="post" enctype="multipart/form-data">
                        ...
                        <div class="checkbox_group">
                            <div class="checkbox_group_row">
                                ...
                                <div class="checkbox_group_options" id="panel_user_type">
                                    <label class="radio-inline">
                                        <input type="radio" id="man" value="男款" name="userType">男款
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" id="woman" value="女款" name="userType">女款
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" id="both" value="通用款" name="userType">通用款
                                    </label>
                                </div>
                            </div>
                            <div class="checkbox_group_row">
                                ...
                                <div class="checkbox_group_options" id="panel_glasses_type">
                                    <label class="radio-inline">
                                        <input type="radio" id="normal" value="框架眼镜" name="glassesType">框架眼镜
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" id="sun" value="太阳眼镜" name="glasseType">太阳眼镜
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" id="radiation" value="防辐射眼镜" name="glassesType">防辐射眼镜
                                    </label>
                                </div>
                            </div>
                            <div class="checkbox_group_row">
                            ...
                            <div class="checkbox_group_row">
                                ...
                                <div class="checkbox_group_options" id="panel_style">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" id="classic" value="经典" name="style">经典
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" id="retro" value="复古" name="style">复古
                                    </label>
                                </div>
                            </div>
                            <div class="checkbox_group_row">
